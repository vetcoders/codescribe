...
pub fn app_automation_state() -> AppAutomationState {
    AppAutomationState {
        ...
        transcription_overlay_visible: false,
...
fn dispatch_action(action: AppAutomationAction) {
    match action {
        ...
        AppAutomationAction::ShowTranscriptionOverlay
        | AppAutomationAction::HideTranscriptionOverlay => {
            // Legacy AppKit transcription overlay was removed on the SwiftUI
            // redesign branch. Keep the automation command surface stable
            // without resurrecting the old renderer.
        }
