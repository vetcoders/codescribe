...
${linesOut}` : summaryText,
  ...
  resetChat() {
    this._setState({ chatHistory: [{ role: "system", content: SYSTEM_PROMPT }], chatStatus: "", chatBusy: false });
  }
