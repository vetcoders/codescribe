...
- **Embedded-first Whisper** — The shipped path centers on a local ~888MB Whisper build; development workflows can still opt into cached/non-embedded installs when needed.
