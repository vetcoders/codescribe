...
**Audio / silence**
- `CODESCRIBE_VAD_ENABLED` – domyślnie `0` (RESTART NEEDED)
...
- `CODESCRIBE_VAD_SILENCE_SEC` – max. cisza przed końcem, domyślnie `1.2` (RESTART NEEDED)
...
- `CODESCRIBE_VAD_THRESHOLD`, `CODESCRIBE_VAD_SILENCE_SEC`, `CODESCRIBE_VAD_ENABLED` (RESTART NEEDED)
