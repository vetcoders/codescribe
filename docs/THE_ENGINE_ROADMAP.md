...
2. ~~hands-free silence as Apple engine lifecycle~~ **done**
   ...
   spans. Do not re-open as "switch the canvas to candle";
3. real take-614 fusion A/B → `CODESCRIBE_SILERO_FUSION` decision;
4. span idempotence observed on a real session → flip decision;
